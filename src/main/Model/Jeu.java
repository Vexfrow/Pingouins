    ...
    public void sauvegarder(String name){
        try {
            ...
            for(int i = 0; i< tailleLista; i++) {
                w.write(coupAnnule.get(i).getLigne() + " "+ coupAnnule.get(i).getColonne() + " " + coupAnnule.get(i).getPingouin().getLigne()+ " " + coupAnnule.get(i).getPingouin().getColonne() + " " + coupAnnule.get(i).estPlace() +"\n");
            }
