...
public class TestsCoups {
    ...
    public static void main(String[] args){
        ...
        Pingouin ping = new Pingouin(jeu.getListeJoueur().get(jeu.getJoueurCourant() - 1).getListePingouin().get(0).getLigne(), jeu.getListeJoueur().get(jeu.getJoueurCourant() - 1).getListePingouin().get(0).getColonne());
        ...
        ping = new Pingouin(jeu.getListeJoueur().get(jeu.getJoueurCourant() - 1).getListePingouin().get(0).getLigne(),jeu.getListeJoueur().get(jeu.getJoueurCourant() - 1).getListePingouin().get(0).getColonne());
        ...
        ping = new Pingouin(jeu.getListeJoueur().get(3).getListePingouin().get(0).getLigne(),jeu.getListeJoueur().get(3).getListePingouin().get(0).getColonne());
        ...
        ping = jeu.getListeJoueur().get(jeu.getJoueurCourant() - 1).getListePingouin().get(1);
        //ping = new Pingouin(jeu.getListeJoueur().get(jeu.getJoueurCourant() - 1).getListePingouin().get(1).getLigne(), jeu.getListeJoueur().get(jeu.getJoueurCourant() - 1).getListePingouin().get(1).getColonne());
        ...
        //assert jeu.getListeJoueur().get(jeu.getJoueurCourant() - 2).getListePingouin().get(1).getLigne() == 6 &&
        //    jeu.getListeJoueur().get(jeu.getJoueurCourant() - 2).getListePingouin().get(1).getColonne() == 6: "Le pingouin n'est pas deplacable en (4,5)";
...
///*
        ...
        System.out.println(jeu.getListeJoueur());
        System.out.println(jeuSauve.getListeJoueur());
